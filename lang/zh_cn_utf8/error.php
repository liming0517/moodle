...
$string['errorcleaningdirectory'] = '清楚目录“{$a}”时发生错误';
$string['errorcopyingfiles'] = '复制文件时发生错误';
$string['errorcreatingdirectory'] = '创建目录“{$a}”时发生错误';
$string['errorcreatingfile'] = '创建文件“{$a}”时发生错误';
$string['erroronline'] = '发生错误于第{$a}行';
$string['errorreadingfile'] = '读取文件“{$a}”时发生错误';
$string['errorunzippingfiles'] = '解压缩文件时发生错误';
...
$string['nonmeaningfulcontent'] = '不是有意义的内容';
$string['notavailable'] = '目前它已经不存在了';
$string['onlyeditingteachers'] = '只有具有编辑权限的教师能够做这个。';
...
$string['sessionerroruser2'] = '一个影响到你的会话线程的服务器错误被检查到。请重新登录或重新启动你的浏览器。';
