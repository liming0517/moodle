...
$string['backup'] = '备份';
$string['backupcancelled'] = '备份已经被取消';
...
$string['courseimportnotaught'] = '你并没有在任何课程中作为编辑教师的权限，没有课程能够为你提供导入。';
$string['courseinfo'] = '课程信息';
$string['coursenotaccessible'] = '这个课程不允许公共访问';
...
$string['healthproblemsdetected'] = '检查到健康问题';
...
$string['parentlanguage'] = '<< 翻译者: 如果你需要为Moodle指定一个父语言当字符串在你的语言包中没有时，那么在这里指定一个语言代码。如果你保持这里为空，将使用英语。例如: nl >>';
...
$string['version'] = '版本';
$string['videoplayer'] = '视频播放器';
$string['view'] = '浏览';
$string['viewsolution'] = '显示解决方案';
