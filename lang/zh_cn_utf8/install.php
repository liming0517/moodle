...
$string['database'] = '数据库';
$string['databasecreationsettings'] = '现在您需要配置数据库了，多数的Moodle数据都将存储在其中。这个数据库将按照如下的设置自动被 Moodle4Windows 安装程序创建。<br />
<br /> <br />
<b>类型:</b> 安装程序固定使用 \"mysql\" <br />
<b>主机:</b> 安装程序固定使用 \"localhost\" <br />
<b>名称:</b> 数据库的名字, 例如 moodle<br />
<b>用户:</b> 安装程序固定使用 \"root\" <br />
<b>密码:</b> root用户的密码<br />
...
$string['globalsquotes'] = '不安全的全局变量处理';
$string['globalsquoteserror'] = '修正你的PHP设置：禁用 register_globals 和/或 启用 magic_quotes_gpc';
$string['globalsquoteshelp'] = '<p>不推荐同时混合禁用Magic Quotes GPC 和启用 Register Globals 。</p>

<p>推荐的设置是 <b>magic_quotes_gpc = On</b> 和<b>register_globals = Off</b> 在你的php.ini</p>

<p>如果你没有修改php.ini的权限，你也许可以放置一个包含下列行的名叫 .htaccess 的文件到你的Moodle目录中:
