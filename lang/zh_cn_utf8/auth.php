...
$string['auth_fieldlocks_help'] = '<p>你可以锁定用户字段。这对于用户数据由管理员手工维护的站点或使用“上载用户”的特性的站点很有用。如果你锁定的字段是Moodle所需要的，确保你在创建用户帐号时提供了相关的信息，否则这个帐号可能会不可用</p><p>考虑设置锁定模式为“空白时锁定”来避免这个问题。';
...
$string['auth_ldap_preventpassindb'] = '选中 yes 阻止Moodle数据库同步修改密码';
...
$string['createchangepassword'] = '创建如果丢失 - 强制修改';
$string['createpassword'] = '创建如果丢失';
...
$string['infilefield'] = '文件中缺少需要的字段';
$string['instructions'] = '使用说明';
$string['locked'] = '已锁定';
$string['md5'] = 'MD5加密';
$string['passwordhandling'] = '密码字段处理';
